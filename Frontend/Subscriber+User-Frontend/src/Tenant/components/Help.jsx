            ...
            {currentSlideData.isOutro && (
              <div className="flex flex-col items-center justify-center mt-12 space-y-8">
                ...
                <p className="text-lg font-medium text-gray-700 mt-6">
                  Besoin d'aide ? Contactez notre support à <a href="mailto:support@planifygo.com" className="text-blue-500 hover:text-blue-600 transition-colors hover:underline">support@planifygo.com</a>
                </p>
              </div>
            )}
          </div>
