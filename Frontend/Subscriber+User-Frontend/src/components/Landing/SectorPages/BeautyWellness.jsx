  ...
  return (
    <div className="bg-white text-gray-800">
      ...
      <section 
        ...
        style={{
          backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.6)), url("https://images.unsplash.com/photo-1540555700478-4be289fbecef?q=80&w=2070")',
      ...
      >
        ...
        <div className="container mx-auto px-4 relative text-center">
          <h1 
            ...
            data-aos="fade-up"
          >
            Réservation simple pour<br />services beauté et bien-être
          </h1>
          <p 
            ...
            data-aos-delay="100"
          >
            Réservez massages, soins esthétiques et services bien-être en quelques clics.
          </p>
          <a
            href="/booking-beauty"
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p 
            ...
            data-aos-delay="100"
          >
            Réservez facilement ces services proposés par des professionnels qualifiés pour prendre soin de vous.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Réservez des séances de massages relaxants, soins spa et rituels bien-être avec des praticiens expérimentés.
                </p>
                <a href="/booking-beauty/massages" className="mt-4 inline-flex items-center text-pink-600 font-medium hover:text-pink-800">
                  Réserver 
            ...
            >
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-3">Soins Esthétiques</h3>
                <p className="text-gray-600">
                  Trouvez et réservez des soins du visage, manucure, pédicure et autres prestations esthétiques.
                </p>
                <a href="/booking-beauty/esthetique" className="mt-4 inline-flex items-center text-pink-600 font-medium hover:text-pink-800">
                  Réserver 
                  <svg className="ml-2 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                </a>
              </div>
            ...
            >
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-3">Coiffure et Barbier</h3>
                <p className="text-gray-600">
                  Réservez des rendez-vous en salon de coiffure ou chez le barbier pour tous vos besoins capillaires.
                </p>
                <a href="/booking-beauty/coiffure" className="mt-4 inline-flex items-center text-pink-600 font-medium hover:text-pink-800">
                  Réserver 
                  <svg className="ml-2 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                </a>
              </div>
      ...
      <section className="bg-gray-50 py-20">
        <div className="container mx-auto px-4">
          ...
          <p 
            ...
            data-aos-delay="100"
          >
            Notre plateforme facilite la mise en relation avec des professionnels de la beauté et du bien-être.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              ...
              <p className="text-gray-600">Planifiez vos rendez-vous quand cela vous convient, avec un système accessible jour et nuit.</p>
            </div>
            {/* Avantage 2 */}
            <div 
              className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-3">Professionnels certifiés</h3>
            ...
            >
              ...
              <p className="text-gray-600">Consultez les avis de vrais clients pour choisir le prestataire qui correspond le mieux à vos besoins.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white relative">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <p 
            ...
            data-aos-delay="100"
          >
            Trouvez et réservez facilement des services dans ces différentes catégories.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="p-6 md:p-8 flex flex-col justify-center">
                ...
                <p className="text-gray-600 mb-4">
                  Réservez des nettoyages, hydratations, anti-âge et autres soins du visage personnalisés.
                </p>
                <a href="/booking-beauty/visage" className="inline-flex items-center text-pink-600 font-medium hover:text-pink-800">
            ...
            >
              ...
              />
              <div className="p-6 md:p-8 flex flex-col justify-center">
                <h3 className="text-xl font-semibold mb-3">Massages thérapeutiques</h3>
                <p className="text-gray-600 mb-4">
                  Réservez des massages relaxants, décontracturants, sportifs et autres techniques de massage.
                </p>
                <a href="/booking-beauty/massages-therapeutiques" className="inline-flex items-center text-pink-600 font-medium hover:text-pink-800">
                  Voir les disponibilités 
                  <svg className="ml-2 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                </a>
              </div>
            ...
            >
              ...
              />
              <div className="p-6 md:p-8 flex flex-col justify-center">
                <h3 className="text-xl font-semibold mb-3">Coiffure et styling</h3>
                <p className="text-gray-600 mb-4">
                  Réservez coupes, colorations, coiffures pour événements et tous types de soins capillaires.
                </p>
                <a href="/booking-beauty/coiffure-styling" className="inline-flex items-center text-pink-600 font-medium hover:text-pink-800">
                  Voir les disponibilités 
                  <svg className="ml-2 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                </a>
              </div>
            ...
            >
              ...
              />
              <div className="p-6 md:p-8 flex flex-col justify-center">
                <h3 className="text-xl font-semibold mb-3">Manucure et onglerie</h3>
                <p className="text-gray-600 mb-4">
                  Réservez des séances de manucure, pose de vernis semi-permanent, extensions d'ongles et soins des mains.
                </p>
                <a href="/booking-beauty/onglerie" className="inline-flex items-center text-pink-600 font-medium hover:text-pink-800">
                  Voir les disponibilités 
                  <svg className="ml-2 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                </a>
              </div>
      ...
      <section 
        ...
        style={{
          backgroundImage: 'linear-gradient(rgba(219, 39, 119, 0.85), rgba(190, 24, 93, 0.9)), url("https://images.unsplash.com/photo-1540555700478-4be289fbecef?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80")',
          backgroundSize: 'cover',
      ...
      >
        ...
        <div className="container mx-auto px-4 relative text-center text-white">
          ...
          <p 
            ...
            data-aos-delay="100"
          >
            Rejoignez des milliers d'utilisateurs satisfaits et trouvez le service beauté et bien-être qui vous correspond.
          </p>
          <a
            href="/booking-beauty"
