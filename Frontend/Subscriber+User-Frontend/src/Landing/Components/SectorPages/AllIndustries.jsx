  ...
  return (
    <div className="bg-white text-gray-800">
      ...
      <section
        ...
        style={{
          backgroundImage:
            'linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.7)), url("https://images.unsplash.com/photo-1496247749665-49cf5b1022e9?q=80&w=2070")',
      ...
      >
        ...
        <div className="container mx-auto px-4 relative text-center">
          ...
          <p
            ...
            data-aos-delay="100"
          >
            Réservez des services professionnels, consultations et prestations
            spécialisées en quelques clics.
          </p>
          <a
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Réservez des séances de consultation avec des experts dans
                  divers domaines d'activité.
                </p>
                <a
                  href="/booking-industries/consultation"
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Trouvez et réservez des prestations techniques adaptées à vos
                  besoins professionnels.
                </p>
                <a
                  href="/booking-industries/technique"
                  className="mt-4 inline-flex items-center text-blue-600 font-medium hover:text-blue-800"
                >
                  Réserver
                  <svg
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Réservez des places pour des ateliers et formations
                  spécialisés dans votre secteur.
                </p>
                <a
                  href="/booking-industries/ateliers"
                  className="mt-4 inline-flex items-center text-blue-600 font-medium hover:text-blue-800"
                >
                  Réserver
                  <svg
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="p-6 md:p-8 flex flex-col justify-center">
                ...
                <p className="text-gray-600 mb-4">
                  Réservez des sessions de conseil en stratégie d'entreprise,
                  gestion de projet et optimisation des processus.
                </p>
                <a
                  href="/booking-industries/management"
            ...
            >
              ...
              <div className="p-6 md:p-8 flex flex-col justify-center">
                ...
                <p className="text-gray-600 mb-4">
                  Réservez des prestations de développement, d'intégration
                  technique et d'audit informatique.
                </p>
                <a
                  href="/booking-industries/it"
                  className="inline-flex items-center text-blue-600 font-medium hover:text-blue-800"
                >
                  Voir les disponibilités
                  <svg
            ...
            >
              ...
              <div className="p-6 md:p-8 flex flex-col justify-center">
                ...
                <p className="text-gray-600 mb-4">
                  Réservez des prestations de stratégie marketing, création de
                  contenu et gestion de campagnes.
                </p>
                <a
                  href="/booking-industries/marketing"
                  className="inline-flex items-center text-blue-600 font-medium hover:text-blue-800"
                >
                  Voir les disponibilités
                  <svg
            ...
            >
              ...
              <div className="p-6 md:p-8 flex flex-col justify-center">
                ...
                <p className="text-gray-600 mb-4">
                  Réservez des consultations en gestion financière,
                  planification fiscale et optimisation comptable.
                </p>
                <a
                  href="/booking-industries/finance"
                  className="inline-flex items-center text-blue-600 font-medium hover:text-blue-800"
                >
                  Voir les disponibilités
                  <svg
