          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="flex-1">
                ...
                {/* Image browser avec les images réelles */}
                {activeStep === index && (
                  <div className="mt-3 bg-gray-100 rounded-lg overflow-hidden border border-gray-200 shadow-md">
                    {/* Barre du navigateur avec les boutons */}
                    <div className="p-2 bg-gray-200 flex items-center">
                      ...
                      <div className="flex-1 bg-white/70 rounded-md h-6 mx-16 flex items-center justify-center text-xs text-gray-500">
                        planifygo.app
                      </div>
                    </div>

                    {/* Contenu avec l'image */}
