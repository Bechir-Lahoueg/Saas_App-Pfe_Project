  ...
  return (
    <div className="bg-white text-gray-800">
      ...
      <section
        ...
        style={{
          backgroundImage:
            'linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.7)), url("https://images.unsplash.com/photo-1513258496099-48168024aec0?q=80&w=2070")',
      ...
      >
        ...
        <div className="container mx-auto px-4 relative text-center">
          ...
          <p
            ...
            data-aos-delay="100"
          >
            Réservez des cours particuliers, formations professionnelles et
            ateliers éducatifs en quelques clics.
          </p>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p
            ...
            data-aos-delay="100"
          >
            Réservez facilement ces services éducatifs proposés par des
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Réservez des séances de soutien scolaire dans toutes les
                  matières avec des tuteurs expérimentés.
                </p>
                <a
                  href="/booking-education/cours"
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Trouvez et réservez des formations certifiantes adaptées au
                  marché du travail.
                </p>
                <a
                  href="/booking-education/formations"
                  className="mt-4 inline-flex items-center text-blue-600 font-medium hover:text-blue-800"
                >
                  Réserver
                  <svg
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Réservez des places pour des ateliers artistiques et créatifs
                  pour tous les âges.
                </p>
                <a
                  href="/booking-education/ateliers"
                  className="mt-4 inline-flex items-center text-blue-600 font-medium hover:text-blue-800"
                >
                  Réserver
                  <svg
      ...
      <section className="bg-gray-50 py-20">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            professionnels de l'éducation qualifiés.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              ...
              <p className="text-gray-600">
                Planifiez des séances quand cela vous convient, avec un système
            ...
            >
              ...
              <p className="text-gray-600">
                Comparez facilement les profils, disponibilités et tarifs des
                différents prestataires éducatifs.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white relative">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <p
            ...
            data-aos-delay="100"
          >
            Trouvez et réservez facilement des services éducatifs dans ces
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="p-6 md:p-8 flex flex-col justify-center">
                ...
                <p className="text-gray-600 mb-4">
                  Réservez des cours d'anglais, espagnol, chinois et autres
                  langues avec des professeurs qualifiés.
                </p>
                <a
                  href="/booking-education/langues"
            ...
            >
              ...
              <div className="p-6 md:p-8 flex flex-col justify-center">
                ...
                <p className="text-gray-600 mb-4">
                  Réservez des cours de programmation, design web, et autres
                  compétences technologiques.
                </p>
                <a
                  href="/booking-education/informatique"
                  className="inline-flex items-center text-blue-600 font-medium hover:text-blue-800"
                >
                  Voir les disponibilités
                  <svg
            ...
            >
              ...
              <div className="p-6 md:p-8 flex flex-col justify-center">
                ...
                <p className="text-gray-600 mb-4">
                  Réservez des séances de soutien en mathématiques, français,
                  sciences pour élèves de tous niveaux.
                </p>
                <a
                  href="/booking-education/soutien"
                  className="inline-flex items-center text-blue-600 font-medium hover:text-blue-800"
                >
                  Voir les disponibilités
                  <svg
            ...
            >
              ...
              <div className="p-6 md:p-8 flex flex-col justify-center">
                ...
                <p className="text-gray-600 mb-4">
                  Réservez des sessions de coaching en gestion du temps,
                  communication, leadership et plus.
                </p>
                <a
                  href="/booking-education/developpement"
                  className="inline-flex items-center text-blue-600 font-medium hover:text-blue-800"
                >
                  Voir les disponibilités
                  <svg
      ...
      <section
        ...
        style={{
          backgroundImage:
            'linear-gradient(rgba(37, 99, 235, 0.9), rgba(29, 78, 216, 0.95)), url("https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80")',
          backgroundSize: "cover",
      ...
      >
        ...
        <div className="container mx-auto px-4 relative text-center text-white">
          ...
          >
            ...
            service éducatif qui vous correspond.
          </p>
          <a
