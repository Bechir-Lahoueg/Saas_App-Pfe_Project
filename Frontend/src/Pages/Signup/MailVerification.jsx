    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="flex items-center justify-center flex-grow px-4">
        <div className="bg-white shadow-lg rounded-2xl p-8 max-w-md w-full text-center">
          <h1 className="text-3xl font-extrabold text-blue-600">Vérifiez votre adresse e-mail</h1>
          <p className="mt-4 text-gray-600">
            Nous avons envoyé un code de sécurité à six chiffres à <b>fajaxoh834@proscrid.com</b>.<br />
          ...
          <p className="mt-4 text-sm text-gray-500">Vous n'avez pas reçu le code ? <a href="#" className="text-blue-600 hover:underline">Renvoyer</a></p>
        </div>
      </div>
      <Footer />
    </div>
